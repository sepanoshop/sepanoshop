function setAzan(tagId,selectedCity)
{
    var a = "<div id='aaaa' style='display:block;vertical-align: middle;padding: 30px;' >\n\
...
<input type=hidden id=azan_mt5 name=azan_mt5 >"+
    "<table border=0 width=151 style='font-family: Tahoma; font-size: 8pt;text-align: center;vertical-align: middle' dir=rtl height=30>\n\
<tr>	\n\
    <td align=center><span id=azanazan></span>&nbsp;&nbsp;&nbsp;&nbsp;\n\
    </td>\n\
</tr>	\n\
</table>"+
    "<table border=0 width=156 style='font-family: Tahoma; font-size: 8pt'>\n\
<tr>\n\
<td align=center id=azan_t1>&nbsp;</td>\n\
<td dir=rtl width=58%>	<img border=0 src=js/azan/s-flash.gif width=10 height=7 id=azan_p1> \n\
<span>&#1575;&#1584;&#1575;&#1606; &#1589;&#1576;&#1581;</span>\n\
</td></tr>\n\
<tr><td align=center id=azan_t2>&nbsp;</td>\n\
<td dir=rtl width=58%><img border=0 src=js/azan/s-flash.gif width=0 height=0 id=azan_p2> <span>&#1591;&#1604;&#1608;&#1593; &#1582;&#1608;&#1585;&#1588;&#1740;&#1583;</span></td>	\n\
</tr><tr><td align=center id=azan_t3>&nbsp;</td><td dir=rtl width=58%>\n\
<img border=0 src=js/azan/s-flash.gif width=0 height=0 id=azan_p3> <span>&#1575;&#1584;&#1575;&#1606; &#1592;&#1607;&#1585;</span>\n\
</td></tr><tr><td align=center id=azan_t4>&nbsp;</td>\n\
<td dir=rtl width=58%><img border=0 src=js/azan/s-flash.gif width=0 height=0 id=azan_p4>	 \n\
<span>&#1594;&#1585;&#1608;&#1576; &#1582;&#1608;&#1585;&#1588;&#1740;&#1583;</span></td></tr>\n\
<tr><td align=center id=azan_t5>&nbsp;</td><td dir=rtl width=58%>\n\
<img border=0 src=js/azan/s-flash.gif width=0 height=0 id=azan_p5> 	<span>&#1575;&#1584;&#1575;&#1606; &#1605;&#1594;&#1585;&#1576;</span></td></tr></table>"+
    "<table border=0 width=150 cellspacing=0 cellpadding=0 style='font-family: Tahoma; font-size: 8pt' dir='rtl' height=30>\n\
<tr>	\n\
<td align=center><span>&#1575;&#1608;&#1602;&#1575;&#1578; &#1576;&#1607; &#1575;&#1601;&#1602; : \n\
<select id=cities size=1 name=c dir=rtl style='font-family: Tahoma; font-size: 8pt; width: 69; height: 19' onchange='coord();main();'>\n\
...
<option value='&#1740;&#1586;&#1583;'>&#1740;&#1586;&#1583;</option></select></span>&nbsp;&nbsp;&nbsp; </td></table>\n\
</div>";
    $("#"+tagId).html(a);
    init();
    document.getElementById('cities').selectedIndex=selectedCity;
    coord();
    main();
}
...
function offshownow(){
//    document.getElementById("azan_p1").src="js/azan/s-flash.gif";
//    document.getElementById("azan_p2").src="js/azan/s-flash.gif";
//    document.getElementById("azan_p3").src="js/azan/s-flash.gif";
//    document.getElementById("azan_p4").src="js/azan/s-flash.gif";
//    document.getElementById("azan_p5").src="js/azan/s-flash.gif";
}
...
function shownow(){
    ...
    if (azan_ttt.getTime( ) > today.getTime( )){
        offshownow();
        document.getElementById("azan_p1").src="js/azan/flasher.gif"
        ...
        if (azan_ttt.getTime() == today.getTime()) {
            ...
            if (azan_ttt.getTime( ) > today.getTime( )) {
                offshownow();
                document.getElementById("azan_p2").src="js/azan/flasher.gif"
                diff = azan_ttt.getTime( ) - today.getTime( );
                diff = Math.floor(diff / (1000 * 60 ));
                hh= Math.floor(diff / ( 60 ));
                ss=diff-(hh * 60) 
                ...
                if (azan_ttt.getTime() == today.getTime()){
                    ...
                    if (azan_ttt.getTime( ) > today.getTime( )) {
                        offshownow();
                        document.getElementById("azan_p3").src="js/azan/flasher.gif"
                        diff = azan_ttt.getTime( ) - today.getTime( );
                        diff = Math.floor(diff / (1000 * 60 ));
                        hh= Math.floor(diff / ( 60 ));
                        ss=diff-(hh * 60) 
                        ...
                        if (azan_ttt.getTime() == today.getTime()){
                            ...
                            if (azan_ttt.getTime( ) > today.getTime( )) {
                                offshownow();
                                document.getElementById("azan_p4").src="js/azan/flasher.gif"
                                diff = azan_ttt.getTime( ) - today.getTime( );
                                diff = Math.floor(diff / (1000 * 60 ));
                                hh= Math.floor(diff / ( 60 ));
                                ss=diff-(hh * 60) 
                                ...
                                if (azan_ttt.getTime() == today.getTime()){
                                    ...
                                    if (azan_ttt.getTime( ) > today.getTime( )){
                                        offshownow();
                                        document.getElementById("azan_p5").src="js/azan/flasher.gif"
                                        diff = azan_ttt.getTime( ) - today.getTime( );
                                        diff = Math.floor(diff / (1000 * 60 ));
                                        hh= Math.floor(diff / ( 60 ));
                                        ss=diff-(hh * 60) 
